...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="relative h-screen overflow-hidden scroll-animate">
      {/* Slides */}
          ...
          <div className="relative z-10 h-full flex items-end">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
              <div className="max-w-2xl">
                ...
                <p className="text-lg md:text-xl text-white/90 mb-8 leading-relaxed">{slide.subtitle}</p>
                <Button
                  size="lg"
                  className="bg-[#CE7725] hover:bg-[#3A2420] text-white px-8 py-4 text-lg shadow-lg hover:shadow-xl transition-all duration-300"
